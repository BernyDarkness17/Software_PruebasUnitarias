...
public class CrearAsignatura extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            a.setNombre(nombre);
            a.setId_docente(Integer.parseInt(request.getParameter("selectdocente")));
            a.setAsistencia(Integer.parseInt(request.getParameter("txtAsistencia")));

            DAOFactory.getInstance().getAsignaturaDAO(DAOFactory.Motor.MY_SQL).create(a);

            response.sendRedirect("crearAsignaturaD.jsp");
